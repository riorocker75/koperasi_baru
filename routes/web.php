...
//--pengaturan simpanan khusus
Route::get('/admin/pengaturan/simpanan-khusus', 'Admin\SimpananCtrl@atur_khusus');
Route::post('/admin/pengaturan/simpanan-khusus/tambah','Admin\SimpananCtrl@atur_khusus_act');
Route::get('/admin/pengaturan/simpanan-khusus/edit/{id}', 'Admin\SimpananCtrl@atur_khusus_edit');
Route::post('/admin/pengaturan/simpanan-khusus/update/{id}', 'Admin\SimpananCtrl@atur_khusus_update');

Route::get('/admin/pengaturan/simpanan-khusus/hapus/{id}','Admin\SimpananCtrl@atur_khusus_hapus');
